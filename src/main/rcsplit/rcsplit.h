...
typedef enum {
    RCSPLIT_CTRL_ARGU_PRESS_WIFI_BUTTON = 1,
    RCSPLIT_CTRL_ARGU_PRESS_POWER_BUTTON = 2,
    RCSPLIT_CTRL_ARGU_PRESS_CHANGE_MODE_BUTTON = 3,
    RCSPLIT_CTRL_ARGU_WHO_ARE_YOU = 4,
