...
int rcdeviceFillRegion(displayPort_t *displayPort, uint8_t x, uint8_t y, uint8_t width, uint8_t height, uint8_t value)
{
    UNUSED(displayPort);
...
int rcdeviceReloadProfile(displayPort_t *displayPort)
{
    UNUSED(displayPort);
    return 0;
}
